...
// League thresholds — XP → league name
const LEAGUES=[
  {id:'legend',label:'👑 Легенда',min:3000},
  {id:'platinum',label:'💎 Платина',min:1500},
  {id:'gold',label:'🥇 Золото',min:700},
  {id:'silver',label:'🥈 Срібло',min:300},
